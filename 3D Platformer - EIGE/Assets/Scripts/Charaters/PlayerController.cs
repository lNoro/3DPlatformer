...
/*
 * Script with all Player Behaviour
 */
...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        //If player is currently going through inlevel Gate, only do that
        if (m_EnterDoor)
        {
    ...
    /*
     * Checks if Player is midAir or grounded
     */
    ...
    /*
     * Invoked when entering Boss Room
     */
